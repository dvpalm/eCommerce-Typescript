...
let printCarrello = () => {
    ...
    if (mioCarrello) { mioCarrello.innerHTML = ''; }
...
function spedizione() {
    ...
    let express: any = document.querySelector('#express');
